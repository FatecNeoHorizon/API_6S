...
- **Estimated Team Capacity:** `38`
- **Sprint Goal:** Deliver user stories `US10: Physical SAM Calculation`, `US11: Geographic Heatmap`, `US12: Authentication and Session Management`, `US13: Authorization and Route Protection`, `US14: Retention, Anonymization`, and `US15: Automatic Recalculation and Upload`, consolidating the strategic, access-control, compliance and post-processing layer of the product.
...
| -- | ---------- | ------ | ---------- | ---------- | ------ |
| US10 | Medium | [Physical SAM Calculation](https://github.com/FatecNeoHorizon/API_6S/wiki/US10-%E2%80%94-Physical-SAM-Calculation) | As a commercial analyst, I want a SAM indicator, to identify the accessible market for the product by region based on technical and regulatory criteria. | 5 | 3 |
